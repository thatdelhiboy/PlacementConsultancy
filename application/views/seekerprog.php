...
<div class="block"></div>
			<table class="table table-responsive-md table-bordered table-sm table-striped">
				...
				<tr>
					<td>Qualification</td>
					<td><?php echo anchor("Welcome/seekerprog/{$this->session->userdata['Mobile']}","Qualification" ,['class'=>'btn btn-primary']);?></td>
				</tr>
				<tr>
					<td>Add Qualification</td>
					<td><?php echo anchor("Welcome/addqualification/{$this->session->userdata['Mobile']}","Add Qualification",['class'=>'btn btn-primary']);?></td>
				</tr>
