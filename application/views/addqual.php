...
<div class="col-sm-2"><?php echo form_error('course','<div class="text-danger">','</div>');?></div>
...
<div class="form-group col-md-4">
	...
	<div class="col-sm-2"><?php echo form_error('board','<div class="text-danger">','</div>');?></div>
</div>
<div class="form-row">	
<div class="form-group col-md-4">
...
<div class="col-sm-2"><?php echo form_error('percentage','<div class="text-danger">','</div>');?></div>

<div class="form-group col-md-4">
	<label>Year</label>
		<?php echo form_input(['name'=>'year','class'=>'form-control','placeholder'=>'Year']);?>
	</div>
	<div class="col-sm-2"><?php echo form_error('year','<div class="text-danger">','</div>');?></div>
</div>
